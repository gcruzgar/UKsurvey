...
def hh_list():
    ...
    data = data.loc[data['fwintvd_dv'] != -21.0]  # drop any BHPS households not present in UKHLS, i.e. if first wave interview (UKHLS) is inapplicable. 
    hidp_list = data[['pidp', 'a_hidp', 'b_hidp', 'c_hidp', 'd_hidp', 'e_hidp', 'f_hidp', 'g_hidp']] # only save households ids
